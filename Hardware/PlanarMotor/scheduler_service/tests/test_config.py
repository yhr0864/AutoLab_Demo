...
class TestConfig:
    ...
    test_cases: list = field(default_factory=lambda: [
        {"name": "PCR pickup",    "station_name": "station_02_pcr_01", "move_type": "pickup"},
        {"name": "Sealer deliver", "station_name": "station_04_sealer_01", "move_type": "pickup"},
    ])
