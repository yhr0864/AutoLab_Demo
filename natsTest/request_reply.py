...
async def main():
    ...
    # Without callback func from subscribe(), there is no feedback and then request timeout.
    ...
    # Callback func contains respond(), publish is no longer available.
    # await nc.publish("greet.ass", b'World')
